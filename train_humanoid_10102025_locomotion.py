...
"""Train Humanoid 10102025 with reinforcement learning using RSL-RL (same as SNC R5)."""
...
# Import the humanoid 10102025 environment configuration
from isaaclab_tasks.direct.humanoid_10102025.humanoid_10102025_env import Humanoid10102025EnvCfg
...
def main():
    ...
    env = gym.make("Isaac-Humanoid-10102025-Direct-v0", cfg=env_cfg, render_mode="rgb_array" if args_cli.video else None)

    # wrap around environment for rsl-rl
    env = RslRlVecEnvWrapper(env)

    # specify directory for logging experiments
    log_root_path = os.path.join("logs", "rsl_rl", "humanoid_10102025")
    ...
    # Policy configuration (same architecture as SNC R5)
